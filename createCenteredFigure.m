function fig = createCenteredFigure(varargin)
    ...
    %
    % 사용 예시:
    %   fig = createCenteredFigure();
    %   fig = createCenteredFigure('Size', [800, 600]);
    %   fig = createCenteredFigure('Size', [800, 600], 'Move', [200, 100]);
    %   fig = createCenteredFigure('Size', [800, 600], 'Name', 'Custom Figure', 'Color', [0.7, 0.7, 0.7]);
